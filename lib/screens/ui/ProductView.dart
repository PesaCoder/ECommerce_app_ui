...
class _ProductView extends State<ProductView> {
  ...
  Widget build(BuildContext context) {
    ...
    String tag = cartProvider.lastOrder == null
        ? "tagHero${widget.product.id}"
        : "tagHeroOrder${cartProvider.lastOrder.id}";
                ...
                child: new SingleChildScrollView(
                    child: new Column(
                      ...
                      new Center(
                        child: Hero(
                          tag: tag,
                          child: new Image.asset(widget.product.urlToImage,
                              fit: BoxFit.cover,
